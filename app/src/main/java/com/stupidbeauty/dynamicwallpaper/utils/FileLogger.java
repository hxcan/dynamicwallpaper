package com.stupidbeauty.dynamicwallpaper.utils;
...
public class FileLogger {
    ...
    private static void rotateLogFile() {
        try {
            ...
            String logFileName = "dynamicwallpaper_" + dateStr + "_" + timeStr + ".log";
    ...
    private static void cleanupOldLogs() {
        try {
            ...
            File[] logFiles = logDir.listFiles((dir, name) -> name.startsWith("dynamicwallpaper_") && name.endsWith(".log"));
